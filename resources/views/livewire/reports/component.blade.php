...
<script>
         function exportPdf(){
            ...
            pdf.text(20,17,"Moto Centro San José");
            pdf.text(20,23,"San José Poaquil, \nChimaltenango");

            var image1 = new Image();
            image1.src = "assets/img/livewire_logo.png"; /// URL de la imagen
            pdf.addImage(image1, 'png', 168, 12, 20, 20);
            ...
            pdf.text(70, 275, "F_______________________");
            pdf.text(90, 282,"Carlos Álvarez");
